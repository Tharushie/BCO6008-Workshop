...
#test vs train partitioning (split) -
...
#to see how many volcano numbers are there - 
...
juice(volcano_prep)
#if you need to apply the recipe to new data (which is not in the recipe settings)
bake()
